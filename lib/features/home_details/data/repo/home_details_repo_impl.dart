...
class HomeDetailsRepoImpl implements HomeDetailsRepo {
  ...
  @override
  Future<Either<Failure, ProductDetailsModel>> getProductDetails({required productId}) async{
    try {
      ProductDetailsModel productDetailsModel = await apiService.getProductDetails(productId: productId);
